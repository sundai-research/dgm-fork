...
def run_conversation(user_prompt):
    ...
    print("Assistant first response:", response_message)
    ...
    if tool_calls:
        ...
        print("Assistant second response:", second_response.choices[0].message)
        from IPython import embed; embed()
        return second_response.choices[0].message.content
# Example usage
user_prompt = "What is ((25 * 4 + 10)**10/2?)**0.324"
